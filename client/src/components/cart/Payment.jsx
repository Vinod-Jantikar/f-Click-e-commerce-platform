...
import {MdPayments,MdAccountBalance, MdCreditCard} from 'react-icons/md'
...
import { getOrderProductsData } from "../../redux/yourOrder/actions";
...
export const Payment = () => {
  ...
  useEffect(() => {
    document.title = "Payment | f-Click shopping platform";
  }, []);
      ...
      <div className="cart_items_container payment_container">
        <div className="checkout_div_left">
          ...
          <div className="seller_text payment_div payment_method">
            ...
            >
              <MdPayments style={{ marginRight: 5 }} /> Cash On
            ...
            >
              <MdCreditCard style={{ marginRight: 5 }} /> Credit/Debit
              Card
            </button>
            {toggle2 ? (
              <div className="payment_content">
            ...
            >
              <MdAccountBalance style={{ marginRight: 5 }} /> Net
              Banking
            </button>
            {toggle3 ? (
              <div className="payment_content">
